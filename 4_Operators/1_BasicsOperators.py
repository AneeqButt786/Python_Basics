...
the integer remainder of the division. dividend % divisor = remainder.
"""
...
"""
Just as in strings, Python supports forming new lists with a 
repeating sequence using the multiplication operator:
"""
